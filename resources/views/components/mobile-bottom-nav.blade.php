        ...
        @auth
            ...
            <a href="{{ route('cart.index') }}" class="flex flex-col items-center py-2 px-3 {{ request()->routeIs('cart.*') ? 'text-blue-600' : 'text-gray-500' }} transition-colors duration-200">
                <div class="relative">
                    ...
                    <span id="bottomCartCount" class="absolute -top-1 -right-1 bg-blue-600 text-white rounded-full text-xs px-1.5 py-0.5 min-w-[18px] h-[18px] items-center justify-center hidden"></span>
